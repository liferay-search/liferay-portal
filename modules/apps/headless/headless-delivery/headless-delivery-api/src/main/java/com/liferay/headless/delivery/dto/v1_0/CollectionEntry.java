...
@Generated("")
@GraphQLName(
	description = "Represents a persisted Collection, backed by an AssetListEntry, exposed for discovery by the Item Selector.",
	value = "CollectionEntry"
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "CollectionEntry")
public class CollectionEntry implements Serializable {

	public static CollectionEntry toDTO(String json) {
		return ObjectMapperUtil.readValue(CollectionEntry.class, json);
	}

	public static CollectionEntry unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(CollectionEntry.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The Collection Entry's id (=collectionEntryId), kept as classPK for legacy InfoListItemSelectorReturnType parity."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The Collection Entry's primary key. Equal to classPK; exposed explicitly because the field name is meaningful to callers reading the DTO."
	)
	public Long getCollectionEntryId() {
		if (_collectionEntryIdSupplier != null) {
			collectionEntryId = _collectionEntryIdSupplier.get();

			_collectionEntryIdSupplier = null;
		}
	...
	public void setCollectionEntryId(
		...
		_collectionEntryIdSupplier = () -> {
			try {
				return collectionEntryIdUnsafeSupplier.get();
			}
			catch (RuntimeException runtimeException) {
				throw runtimeException;
			}
	...
	@JsonIgnore
	private Supplier<Long> _collectionEntryIdSupplier;
	...
	public String toString() {
		...
		Long collectionEntryId = getCollectionEntryId();
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.delivery.dto.v1_0.CollectionEntry",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:-202594484