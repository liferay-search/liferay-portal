...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "A Java client JAR is available for use with the group ID 'com.liferay', artifact ID 'com.liferay.headless.delivery.client', and version '4.0.106'.", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "Headless Delivery", version = "v1.0")
)
@Path("/v1.0")
	...
	private final Set<Class<?>> _resourceClasses = new HashSet<Class<?>>() {
		{
			...
			add(ContentSetProviderResourceImpl.class);
...
// LIFERAY-REST-BUILDER-HASH:1361191756