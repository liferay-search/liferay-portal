...
public class BulkDocumentRequestExecutorTest {
	...
	public void testBulkDocumentResponseWhenNumberOfTriesIsZero()
		...
		ElasticsearchClientResolver elasticsearchClientResolver = Mockito.mock(
		...
		BulkDocumentRequestExecutor bulkDocumentRequestExecutor =
			new BulkDocumentRequestExecutor(elasticsearchClientResolver, 0, 0);

		BulkDocumentRequest bulkDocumentRequest = new BulkDocumentRequest();

		bulkDocumentRequest.addBulkableDocumentRequest(
			new DeleteDocumentRequest(_INDEX_NAME, "1"));
