...
<c:if test="<%= searchBarPortletInstanceConfigurationDisplayContext.isSuggestionsConfigurationVisible() %>">
	...
	<%
	for (String suggestionsContributorConfiguration : searchBarPortletInstanceConfigurationDisplayContext.getSuggestionsContributorConfigurations()) {
	%>

		<aui:input name="suggestionsContributorConfiguration" type="textarea" value="<%= suggestionsContributorConfiguration %>" />
