...
>
	...
	>
		<clay:multiselect
			helpText='<%= LanguageUtil.get(request, "virtual-instances-help-text") %>'
			id='<%= liferayPortletResponse.getNamespace() + "companyIds" %>'
			inputName='<%= liferayPortletResponse.getNamespace() + "companyIds" %>'
