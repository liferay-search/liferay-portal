...
public class SearchResultSerDes {
	...
	public static String toJSON(SearchResult searchResult) {
		...
		if (searchResult.getDocumentFields() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			if (searchResult.getDocumentFields() instanceof String) {
				sb.append("\"");
				sb.append((String)searchResult.getDocumentFields());
				sb.append("\"");
			}
			else {
				sb.append(searchResult.getDocumentFields());
			}
		}
	...
	public static Map<String, String> toMap(SearchResult searchResult) {
		...
		if (searchResult.getDocumentFields() == null) {
			...
			map.put(
				"documentFields",
				String.valueOf(searchResult.getDocumentFields()));
		}
	...
	public static class SearchResultJSONParser
		...
		protected void setField(
			...
			else if (Objects.equals(jsonParserFieldName, "documentFields")) {
				if (jsonParserFieldValue != null) {
