...
public class SearchResultResourceTest extends BaseSearchResultResourceTestCase {
	...
	public void testPostSearchPage() throws Exception {
		...
		_testPostSearchPageWithEntryClassNames();
	...
	private SearchResult _getFirstSearchResult(Page<SearchResult> page)
		throws Exception {

		List<SearchResult> searchResults = new ArrayList<>(page.getItems());
	...
	private void _testPostSearchPageWithEntryClassNames() throws Exception {
		...
		SearchResult searchResult = _getFirstSearchResult(page);

		Map<String, Object> documentFields =
			(Map<String, Object>)searchResult.getDocumentFields();

		Assert.assertEquals(
			GetterUtil.getString(documentFields.get(Field.ENTRY_CLASS_NAME)),
			clazz.getName());
	}
