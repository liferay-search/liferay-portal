...
public abstract class BaseSearchResultResourceTestCase {
	...
	protected void assertValid(SearchResult searchResult) throws Exception {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("documentFields", additionalAssertFieldName)) {
	...
	protected boolean equals(
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("documentFields", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						searchResult1.getDocumentFields(),
						searchResult2.getDocumentFields())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("documentFields")) {
			throw new IllegalArgumentException(
