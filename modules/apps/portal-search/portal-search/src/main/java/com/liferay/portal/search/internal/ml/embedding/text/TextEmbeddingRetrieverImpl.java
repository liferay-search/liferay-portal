...
public class TextEmbeddingRetrieverImpl implements TextEmbeddingRetriever {
	...
	private boolean _isProviderEnabled(String textEmbeddingProviderName) {
		...
		if (_devTextEmbeddingsEnabled &&
			_devProviders.contains(textEmbeddingProviderName)) {
	...
	private static final List<String> _devProviders = List.of("openai");
	private static final List<String> _supportedProviders = List.of(
		"vertex-ai");
