...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Data.Engine.REST.DataDefinitionMustSetValidCharactersForFieldNameValidationExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class
	DataDefinitionMustSetValidCharactersForFieldNameValidationExceptionMapper
	...
	protected Problem getProblem(
		...
		return new Problem(
			...
			DataDefinitionValidationException.
				MustSetValidCharactersForFieldName.class.getSimpleName());
	}
