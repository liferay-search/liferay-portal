...
public enum ReservedParameterNames {
	...
	LAYOUT_LOCALE_NAME("layout_locale_name"),
	PLID("plid"), 
	SCOPE_GROUP_ID("scope_group_id"),
	TIME_OF_DAY("time_of_day"),
	TIMEZONE_LOCALE_NAME("timezone_locale_name"),
	...
	USER_IS_FEMALE("user_is_female"),
	USER_IS_GENDER_X("user_is_gender_x"),
	...
	public static final ReservedParameterNames findByJsonKey(
		String jsonKey) {
