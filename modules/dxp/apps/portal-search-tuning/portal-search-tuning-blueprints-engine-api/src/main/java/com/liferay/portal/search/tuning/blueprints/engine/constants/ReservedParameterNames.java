...
public enum ReservedParameterNames {
	...
	ALLOW_MISSPELLING("allow_misspelling"), COMPANY_ID("company_id"),
	...
	CURRENT_YEAR("current_year"), EXPLAIN("explain"),
	...
	USER_IS_FEMALE("user_is_female"), USER_IS_GENDER_X("user_is_gender_x"),
	USER_IS_MALE("user_is_male"), USER_JOB_TITLE("user_job_title"),
