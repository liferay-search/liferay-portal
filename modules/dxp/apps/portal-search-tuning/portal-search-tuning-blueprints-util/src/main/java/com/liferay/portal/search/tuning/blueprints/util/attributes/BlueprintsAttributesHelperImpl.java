...
public class BlueprintsAttributesHelperImpl
	...
	public BlueprintsAttributesBuilder getBlueprintsRequestAttributesBuilder(
		...
		return _addConfiguredParameters(
	...
	private BlueprintsAttributesBuilder _addConfiguredParameters(
		PortletRequest portletRequest,
		BlueprintsAttributesBuilder blueprintsAttributesBuilder,
		long blueprintId) {
		...
		Optional<JSONObject> configurationJsonObjectOptional =
				_blueprintHelper.getParameterConfigurationOptional(
					blueprint);
	...
	private void _addCustomParameters(PortletRequest portletRequest,
			BlueprintsAttributesBuilder blueprintsAttributesBuilder, JSONArray jsonArray) {
		...
		for (int i = 0; i < jsonArray.length(); i++) {
			...
			if (_isArrayValue(type)) {
				_addStringValues(portletRequest, blueprintsAttributesBuilder, key);
			}
			else {
	...
	private void _addFacetParameters(PortletRequest portletRequest,
			BlueprintsAttributesBuilder blueprintsAttributesBuilder, JSONArray jsonArray) {
		...
		for (int i = 0; i < jsonArray.length(); i++) {
			...
			boolean arrayValue = jsonObject.getBoolean(
					FacetConfigurationKeys.MULTI_VALUE.
				getJsonKey());
	...
	private void _addSortParameters(PortletRequest portletRequest,
			BlueprintsAttributesBuilder blueprintsAttributesBuilder, JSONArray jsonArray) {
	...
	private void _addPagingParameters(PortletRequest portletRequest,
			BlueprintsAttributesBuilder blueprintsAttributesBuilder, JSONObject jsonObject) {

		_addStringValue(portletRequest, blueprintsAttributesBuilder, jsonObject.getString(
				PageConfigurationKeys.PARAMETER_NAME.
				getJsonKey()));

	}

	private void _addKeywordParameter(PortletRequest portletRequest,
			BlueprintsAttributesBuilder blueprintsAttributesBuilder, 
			JSONObject jsonObject) {

		_addStringValue(portletRequest, blueprintsAttributesBuilder, jsonObject.getString(
				KeywordsConfigurationKeys.PARAMETER_NAME.
				getJsonKey()));

	}
	
	private void _addStringValue(PortletRequest portletRequest,
	...
	private void _addStringValues(PortletRequest portletRequest,
			BlueprintsAttributesBuilder blueprintsAttributesBuilder, String key) {
	...
	@Reference POCMockUtil _pocMockUtil;
}