 ...
 */
public enum GeoBoundsAggregationBodyConfigurationKeys {
	...
	public static final GeoBoundsAggregationBodyConfigurationKeys findByJsonKey(
		...
		Stream<GeoBoundsAggregationBodyConfigurationKeys> stream =
			Arrays.stream(GeoBoundsAggregationBodyConfigurationKeys.values());
	...
	private GeoBoundsAggregationBodyConfigurationKeys(String jsonKey) {
		_jsonKey = jsonKey;
	}
