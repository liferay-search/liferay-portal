...
package com.liferay.portal.search.tuning.blueprints.engine.internal.suggester.spellcheck;
 ...
 */
@Component(
	immediate = true, property = "type=spellcheck", service = Suggester.class
)
public class SpellCheckSuggester implements Suggester {
	...
	public List<String> getSuggestions(
		...
		Optional<JSONArray> configurationJsonArrayOptional =
			_blueprintHelper.getSpellCheckingSuggestersOptional(
