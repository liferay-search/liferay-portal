...
package com.liferay.portal.search.tuning.blueprints.engine.internal.clause.builder;
...
import com.liferay.portal.search.tuning.blueprints.constants.json.keys.clause.SimpleQueryStringConfigurationKeys;
...
public class SimpleQueryStringClauseBuilder implements ClauseBuilder {
	...
	public Optional<Query> buildClause(
		...
		if (Validator.isBlank(keywords)) {
			keywords = searchRequestContext.getKeywords();
		}
