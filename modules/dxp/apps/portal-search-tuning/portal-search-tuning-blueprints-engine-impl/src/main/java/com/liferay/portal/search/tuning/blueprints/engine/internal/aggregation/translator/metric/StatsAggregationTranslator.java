...
import com.liferay.portal.search.tuning.blueprints.constants.json.keys.aggregation.metric.StatsAggregationBodyConfigurationKeys;
 ...
 */
@Component(
	immediate = true, property = "name=stats",
	service = AggregationTranslator.class
)
public class StatsAggregationTranslator
	...
	public Optional<Aggregation> translate(
		...
		StatsAggregation aggregation = _aggregations.stats(
			aggregationName,
			bodyJSONObject.getString(
				StatsAggregationBodyConfigurationKeys.FIELD.getJsonKey()));
