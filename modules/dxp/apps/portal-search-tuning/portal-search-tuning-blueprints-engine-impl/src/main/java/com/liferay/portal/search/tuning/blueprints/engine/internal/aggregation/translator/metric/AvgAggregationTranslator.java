...
import com.liferay.portal.search.tuning.blueprints.constants.json.keys.aggregation.metric.AvgAggregationBodyConfigurationKeys;
 ...
 */
@Component(
	immediate = true, property = "name=avg",
	service = AggregationTranslator.class
)
public class AvgAggregationTranslator
