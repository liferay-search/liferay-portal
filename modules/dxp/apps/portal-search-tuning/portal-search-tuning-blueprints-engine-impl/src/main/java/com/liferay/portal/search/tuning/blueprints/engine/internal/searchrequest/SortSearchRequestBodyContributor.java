...
public class SortSearchRequestBodyContributor
	...
	public void contribute(
		...
		if (sorts.isEmpty()) {
			sorts = _getDefaultSorts(blueprint, messages);
		}
	...
	private List<Sort> _getDefaultSorts(
		...
		for (int i = 0; i < configurationJsonArray.length(); i++) {
			...
			String field = configurationJsonObject.getString("field");
			String orderString = configurationJsonObject.getString("order");
