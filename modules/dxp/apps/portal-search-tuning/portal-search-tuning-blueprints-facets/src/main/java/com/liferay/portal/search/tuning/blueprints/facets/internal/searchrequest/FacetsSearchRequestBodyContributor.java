 ...
 */
@Component(immediate = true, service = SearchRequestBodyContributor.class)
public class FacetsSearchRequestBodyContributor
	...
	private void _addAggregation(
		...
		String field = _getField(configurationJsonObject);
	...
	private String _getField(JSONObject configurationJsonObject) {
