...
package com.liferay.portal.search.tuning.blueprints.web.poc2.internal.portlet.action;
...
import com.liferay.portal.search.tuning.blueprints.web.poc2.internal.constants.BlueprintsWebKeys;
import com.liferay.portal.search.tuning.blueprints.web.poc2.internal.constants.BlueprintsWebPortletKeys;
import com.liferay.portal.search.tuning.blueprints.web.poc2.internal.constants.JSONResponseKeys;
import com.liferay.portal.search.tuning.blueprints.web.poc2.internal.constants.ResourceRequestKeys;
import com.liferay.portal.search.tuning.blueprints.web.poc2.internal.portlet.preferences.BlueprintsWebPortletPreferences;
import com.liferay.portal.search.tuning.blueprints.web.poc2.internal.portlet.preferences.BlueprintsWebPortletPreferencesImpl;
import com.liferay.portal.search.tuning.blueprints.web.poc2.internal.util.BlueprintsLocalizationHelper;
...
public class GetSearchResultsMVCResourceCommand extends BaseMVCResourceCommand {
	...
	protected void doServeResource(
		...
		String activeResultLayout = 
				_getActiveResultLayout(resourceRequest, blueprintsWebPortletPreferences);
		...
		for (int i = 0; i < facetsJsonArray.length(); i++) {
			...
			facetJsonObject.put(
				"anyOption", _blueprintsLocalizationHelper.
					get(locale, "any-" + facetJsonObject.getString(
						FacetJSONResponseKeys.PARAMETER_NAME).toLowerCase()));
			...
			for (int j = 0; j < facetValuesJsonArray.length(); j++) {
				...
				"text", _blueprintsLocalizationHelper.get(
					locale, valueJsonObject.getString("value").toLowerCase()) + 
