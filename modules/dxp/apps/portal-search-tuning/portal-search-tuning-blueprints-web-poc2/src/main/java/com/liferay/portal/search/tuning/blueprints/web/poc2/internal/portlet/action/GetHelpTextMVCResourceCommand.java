...
public class GetHelpTextMVCResourceCommand extends BaseMVCResourceCommand {
	...
	protected void doServeResource(
		...
		if (Validator.isBlank(helpText)) {
			helpText = _blueprintsLocalizationHelper.get(themeDisplay.getLocale(), "default-helptext");
		}
	...
	private String _getHelpText(
		...
		Optional<String> valueOptional = blueprintsWebPortletPreferences.getHelpTextArticleOptional();
