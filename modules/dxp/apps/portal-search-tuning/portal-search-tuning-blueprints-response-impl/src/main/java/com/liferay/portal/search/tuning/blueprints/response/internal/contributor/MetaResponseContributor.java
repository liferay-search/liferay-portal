 ...
 */
@Component(
	immediate = true, property = "type=meta",
...
public class MetaResponseContributor implements ResponseContributor {
	...
	public void contribute(
		...
		responseJsonObject.put(JSONResponseKeys.META, _getMeta(searchResponse));
	}

	private JSONObject _getMeta(SearchResponse searchResponse) {
