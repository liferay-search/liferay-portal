...
public class TXTAITextEmbeddingProvider
	...
	private void _setAuthOptions(
		...
		String userName = MapUtil.getString(attributes, "username");
		...
		options.setAuth(
			HttpComponentsUtil.getDomain(hostAddress), -1, null, userName,
			MapUtil.getString(attributes, "password", StringPool.BLANK));
	}
