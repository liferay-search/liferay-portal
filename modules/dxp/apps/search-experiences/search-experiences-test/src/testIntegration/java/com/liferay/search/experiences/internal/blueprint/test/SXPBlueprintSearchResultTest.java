...
public class SXPBlueprintSearchResultTest {
	...
	public void testBoostContentsForTheCurrentLanguage() throws Exception {
		...
		_assertSearch(
			"[coca cola en_US, pepsi cola en_US, coca cola es_ES, pepsi cola" +
				" es_ES]");

		_updateElementInstancesJSON(null, null);

		_assertSearch(
			"[coca cola es_ES, coca cola en_US, pepsi cola es_ES, pepsi cola" +
				" en_US]");
	}
	...
	public void testBoostContentsInACategoryForTheTimeOfDay() throws Exception {
		...
		_updateElementInstancesJSON(
			new Object[] {
				HashMapBuilder.<String, Object>put(
					...
					"time_of_day", _getTimeOfDay(localDateTime.toLocalTime())
				).build()
			},
		...
		_updateElementInstancesJSON(null, null); // Not working
