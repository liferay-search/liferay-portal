...
public class AggregationsJSONTranslationContributor
	...
	protected static Optional<String> getFirstKeyOptional(
	...
	private void _addResult(
		...
		try {
			...
			_messagesHelper.invalidConfigurationValueError(
	...
	private void _processAggregation(
		...
		Optional<String> typeOptional = getFirstKeyOptional(nameJSONObject);
