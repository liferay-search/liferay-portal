 ...
 */
@Component(
	immediate = true, property = "name=max_bucket",
	service = AggregationTranslator.class
)
public class MaxBucketAggregationTranslator implements AggregationTranslator {
	...
	public Optional<AggregationWrapper> translate(
		...
		MaxBucketPipelineAggregation aggregation = _aggregations.maxBucket(
