...
public class WeightedAvgAggregationTranslator implements AggregationTranslator {
	...
	public Optional<AggregationWrapper> translate(
		...
		_aggregationHelper.setScript(
			valueJSONObject, aggregation::setValueScript, messages);

		_setterHelper.setObjectValue(
			weightJSONObject, "missing", aggregation::setWeightMissing);

		_aggregationHelper.setScript(
			weightJSONObject, aggregation::setWeightScript, messages);
