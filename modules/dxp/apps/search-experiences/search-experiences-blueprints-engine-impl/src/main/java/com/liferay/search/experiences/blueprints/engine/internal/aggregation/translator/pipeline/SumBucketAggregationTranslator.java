 ...
 */
@Component(
	immediate = true, property = "name=sum_bucket",
	service = AggregationTranslator.class
)
public class SumBucketAggregationTranslator implements AggregationTranslator {
	...
	public Optional<AggregationWrapper> translate(
		...
		SumBucketPipelineAggregation aggregation = _aggregations.sumBucket(
