 ...
 */
@Component(
	immediate = true, property = "name=bucket_selector",
	service = AggregationTranslator.class
)
public class BucketSelectorAggregationTranslator
	...
	public Optional<AggregationWrapper> translate(
		...
		BucketSelectorPipelineAggregation aggregation =
			_aggregations.bucketSelector(aggregationName, scriptOptional.get());
