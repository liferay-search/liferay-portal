...
import com.liferay.search.experiences.blueprints.engine.internal.condition.visitor.InVisitor;
 ...
 */
@Component(
	immediate = true, property = "name=not_in", service = ConditionHandler.class
)
public class NotInConditionHandler implements ConditionHandler {
	...
	public boolean isTrue(
		...
		Function<JSONObject, EvaluationVisitor> function =
			conditionJSONObject -> new InVisitor(
