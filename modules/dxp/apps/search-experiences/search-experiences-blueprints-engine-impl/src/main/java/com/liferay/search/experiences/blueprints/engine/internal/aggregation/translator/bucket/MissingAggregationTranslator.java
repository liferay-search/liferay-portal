 ...
 */
@Component(
	immediate = true, property = "name=missing",
	service = AggregationTranslator.class
)
public class MissingAggregationTranslator implements AggregationTranslator {
	...
	public Optional<AggregationWrapper> translate(
		...
		MissingAggregation aggregation = _aggregations.missing(
