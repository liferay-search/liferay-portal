...
import com.liferay.search.experiences.blueprints.engine.internal.condition.visitor.InRangeVisitor;
 ...
 */
@Component(
	immediate = true, property = "name=in_range",
	service = ConditionHandler.class
)
public class InRangeConditionHandler implements ConditionHandler {
	...
	public boolean isTrue(
		...
		Function<JSONObject, EvaluationVisitor> function =
			conditionJSONObject -> new InRangeVisitor(
